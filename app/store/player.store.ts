...
export const usePlayerStore = create<PlayerStore>((set, get) => ({
  profile: loadFromStorage<PlayerProfile>(
  ...
  updateProfile: (partialProfile) => {
    ...
    saveToStorage(PLAYER_PROFILE_STORAGE_KEY, nextProfile);
  ...
  resetProfile: () => {
    ...
    set({ profile: defaultPlayerProfile });
...
export function setPlayerProfile(profile: PlayerProfile): PlayerProfile {
...
export function updatePlayerProfile(
  ...
  return usePlayerStore.getState().updateProfile(partialProfile);
}
