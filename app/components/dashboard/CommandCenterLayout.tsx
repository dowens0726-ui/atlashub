    ...
    <AtlasCommandCenter>
      <div className="grid min-w-0 gap-6 xl:grid-cols-[18rem_minmax(0,1fr)] 2xl:grid-cols-[19rem_minmax(0,1fr)]">
        ...
        <main className="min-w-0 space-y-8">
          <section
            aria-label="Atlas command brief"
            className="min-w-0"
          >
          ...
          {copilot ? (
            <section
              aria-label="Atlas strategic direction"
              className="min-w-0"
            >
              <AtlasCommandSection
                variant="primary"
          ...
          <section
            aria-labelledby="atlas-executive-workspace-title"
            className="relative min-w-0 overflow-hidden rounded-[2rem] border border-white/[0.08] bg-black/20 p-3 shadow-[0_32px_100px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-5 lg:p-6"
          >
            ...
            <div className="relative">
              <header className="mb-6 flex flex-col gap-4 border-b border-white/[0.07] px-2 pb-6 sm:px-3 lg:flex-row lg:items-end lg:justify-between">
                <div>
                  ...
                  <h2
                    id="atlas-executive-workspace-title"
                ...
                <div className="flex w-fit items-center gap-3 rounded-full border border-cyan-300/15 bg-cyan-300/[0.06] px-4 py-2">
          ...
          <section className="grid min-w-0 gap-8 2xl:grid-cols-2">
            <AtlasCommandSection
